...
/**
 * BoardDetailInsertRequest 서버 코덱
 * @author Won Jonghoon
 *
 */
public final class BoardDetailInsertRequestServerCodec implements MessageCodecIF {

	@Override
	public MessageDecoder getMessageDecoder() throws DynamicClassCallException {
		return new BoardDetailInsertRequestDecoder();
	}
