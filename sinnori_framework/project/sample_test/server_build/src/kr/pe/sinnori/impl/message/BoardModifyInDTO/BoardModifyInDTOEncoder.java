 ...
 *
 */
public final class BoardModifyInDTOEncoder extends MessageEncoder {
	@Override
	...
	private void encodeBody(BoardModifyInDTO boardModifyInDTO, SingleItemEncoderIF singleItemEncoder, Charset charsetOfProject, Object middleWriteObj) throws Exception {
		...
		singleItemEncoder.putValueToMiddleWriteObj(boardModifyInDTOSingleItemPath, "content"
					...
					, charsetOfProject
					, middleWriteObj);
		singleItemEncoder.putValueToMiddleWriteObj(boardModifyInDTOSingleItemPath, "writerId"
					, 7 // itemTypeID
					, "ub pascal string" // itemTypeName
					, boardModifyInDTO.getWriterId() // itemValue
					, -1 // itemSizeForLang
					, null // itemCharset,
					, charsetOfProject
					, middleWriteObj);
