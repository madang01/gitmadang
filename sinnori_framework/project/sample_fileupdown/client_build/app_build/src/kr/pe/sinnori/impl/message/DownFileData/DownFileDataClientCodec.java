...
/**
 * DownFileData 클라이언트 코덱
 * @author Jonghoon Won
 *
 */
public final class DownFileDataClientCodec implements MessageCodecIF {

	@Override
	public MessageDecoder getMessageDecoder() throws DynamicClassCallException {
		return new DownFileDataDecoder();
	}

	@Override
	public MessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("DownFileData메시지는 클라이언트에서 서버로 전달하지 않는 메시지 입니다.");
	}
}