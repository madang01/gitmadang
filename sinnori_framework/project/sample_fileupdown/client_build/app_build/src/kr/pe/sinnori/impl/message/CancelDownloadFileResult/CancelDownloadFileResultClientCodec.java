...
/**
 * CancelDownloadFileResult 클라이언트 코덱
 * @author Jonghoon Won
 *
 */
public final class CancelDownloadFileResultClientCodec implements MessageCodecIF {

	@Override
	public MessageDecoder getMessageDecoder() throws DynamicClassCallException {
		return new CancelDownloadFileResultDecoder();
	}

	@Override
	public MessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("CancelDownloadFileResult메시지는 클라이언트에서 서버로 전달하지 않는 메시지 입니다.");
	}
}