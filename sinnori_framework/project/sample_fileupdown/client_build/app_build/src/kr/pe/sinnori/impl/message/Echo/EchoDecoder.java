...
public final class EchoDecoder extends MessageDecoder {
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Charset charsetOfProject, Object  middleReadObj) throws OutOfMemoryError, BodyFormatException {
		/*echo.setRandomInt(bodyInputStream.getInt());
		echo.setStartTime(bodyInputStream.getLong());*/
		Echo echo = new Echo();
		echo.setRandomInt((Integer)
				singleItemDecoder.getValueFromMiddleReadObj(echo.getMessageID()
				, "randomInt" // itemName
				, 4 // itemType
