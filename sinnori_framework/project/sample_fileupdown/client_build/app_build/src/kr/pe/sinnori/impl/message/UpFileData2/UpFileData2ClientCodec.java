...
/**
 * UpFileData2 클라이언트 코덱
 * @author Jonghoon Won
 *
 */
public final class UpFileData2ClientCodec implements MessageCodecIF {

	@Override
	public MessageDecoder getMessageDecoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("UpFileData2메시지는 서버에서 클라이언트로 전달하지 않는 메시지 입니다.");
	}

	@Override
	public MessageEncoder getMessageEncoder() throws DynamicClassCallException {
		return new UpFileData2Encoder();
	}
}