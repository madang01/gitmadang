...
public class SyncUploadFileTransferTask implements FileTransferTaskIF, CommonRootIF {
	 ...
	 */
	public SyncUploadFileTransferTask(JFrame mainFrame,
			SyncMainControllerIF syncMainController,
			int serverTargetFileID,
			LocalSourceFileResource localSourceFileResource) {
		this.mainFrame = mainFrame;
		this.syncMainController = syncMainController;
		...
		try {
			...
			for (; startFileBlockNo <= endFileBlockNo; startFileBlockNo++) {
				...
				if (localSourceFileResource.isCanceled()) {
					...
					CancelUploadFileResult cancelUploadFileResultOutObj = syncMainController.cancelUploadFile();
				...
				UpFileDataResult upFileDataResultOutObj = syncMainController
	...
	@Override
	public void endTask() {
		syncMainController.endUploadTask();
	}
