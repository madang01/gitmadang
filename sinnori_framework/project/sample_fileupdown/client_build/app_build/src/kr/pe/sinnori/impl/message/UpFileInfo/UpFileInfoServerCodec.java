 ...
 *
 */
public final class UpFileInfoServerCodec implements MessageCodecIF {

	@Override
	public MessageDecoder getMessageDecoder() throws DynamicClassCallException {
		return new UpFileInfoDecoder();
	}

	@Override
	public MessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("UpFileInfo메시지는 서버에서 클라이언트로 전달하지 않는 메시지 입니다.");
	}
}