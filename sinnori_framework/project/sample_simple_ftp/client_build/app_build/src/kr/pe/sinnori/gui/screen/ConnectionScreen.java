...
import kr.pe.sinnori.util.JTextFieldFormatLimit;
...
public class ConnectionScreen extends JPanel implements CommonRootIF {
	...
	private void initialize() {
		...
		hostTextField.setDocument(new JTextFieldFormatLimit(30, null));
		...
		portTextField.setDocument(new JTextFieldFormatLimit(4, "^[0-9]*$"));
		...
		idTextField.setDocument(new JTextFieldFormatLimit(20, "^[a-zA-Z0-9]*$"));
