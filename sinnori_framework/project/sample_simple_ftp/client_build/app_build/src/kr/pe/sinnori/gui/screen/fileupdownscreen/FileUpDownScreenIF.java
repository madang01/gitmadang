...
public interface FileUpDownScreenIF {
	 ...
	 * @throws MessageItemException 원격지 파일 목록 메시지를에서 항목명 관련 에러 발생시 던지는 예외, 예를 들면 항목명이 없을때가 대표적인 경우
	 */
	public void makeRemoteTreeNode(OutputMessage fileListOutObj, RemoteFileTreeNode remoteParentNode) throws MessageItemException;
}
