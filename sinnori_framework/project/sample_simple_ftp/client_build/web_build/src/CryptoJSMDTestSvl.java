...
public class CryptoJSMDTestSvl extends AbstractServlet {
	...
	protected void performTask(HttpServletRequest req, HttpServletResponse res)
		...
		if (null == pageGubun || pageGubun.equals("step1")) {
			...
			byte[] javascriptMD = HexUtil.hexToByteArray(javascriptMDHex);
			...
			log.info(String.format("server digestMessage[%s]", HexUtil.byteArrayAllToHex(serverMD)));
			...
			req.setAttribute("serverMDHex", HexUtil.byteArrayAllToHex(serverMD));
