...
/**
 * 메세지 식별자 NotExist08 비지니스 로직
 * 
 * @author Jonghoon Won
 * 
 */
public final class NotExist08SExtor extends AbstractServerExecutor {
	...
	protected void doTask(ServerProjectConfigIF serverProjectConfig,
		...
		OutputMessage outObj = messageManger.createOutputMessage("NotExist08");
