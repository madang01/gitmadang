...
/**
 * 메세지 식별자 NotExist02 비지니스 로직
 * 
 * @author Jonghoon Won
 * 
 */
public final class NotExist02SExtor extends AbstractServerExecutor {
	...
	protected void doTask(CommonProjectInfo commonProjectInfo,
		...
		/*
		 * NotExist02OutputMessage outObj = new NotExist02OutputMessage();
		 * outObj.mCase = inObj.mCase;
		 */
		OutputMessage outObj = messageManger.createOutputMessage("NotExist02");
