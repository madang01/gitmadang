...
/**
 * 메세지 식별자 NotExist09 비지니스 로직
 * 
 * @author Jonghoon Won
 * 
 */
public final class NotExist09SExtor extends AbstractServerExecutor {
	...
	protected void doTask(SocketChannel fromSC, InputMessage inObj,
		...
		OutputMessage outObj = messageManger.createOutputMessage("NotExist09");
