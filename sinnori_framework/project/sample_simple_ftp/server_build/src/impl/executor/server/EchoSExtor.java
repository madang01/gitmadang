...
/**
 * 메세지 식별자 Echo 비지니스 로직
 * 
 * @author Jonghoon Won
 * 
 */
public final class EchoSExtor extends AbstractServerExecutor {
	...
	protected void doTask(CommonProjectInfo commonProjectInfo,
		...
		OutputMessage outObj = messageManger.createOutputMessage("Echo");

		outObj.setAttribute("randomInt",
				(int) inObj.getAttribute("randomInt"));
		outObj.setAttribute("startTime",
