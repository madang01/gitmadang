...
/**
 * 메세지 식별자 SelfExn 비지니스 로직
 * 
 * @author Jonghoon Won
 * 
 */
public final class SelfExnSExtor extends AbstractServerExecutor {
	...
	protected void doTask(ServerProjectConfigIF serverProjectConfig,
		...
		OutputMessage outObj = messageManger.createOutputMessage("SelfExn");

		outObj.setAttribute("whereError", (String) inObj.getAttribute("whereError"));
		outObj.setAttribute("errorGubun", (String) inObj.getAttribute("errorGubun"));
		outObj.setAttribute("errorMessageID",
