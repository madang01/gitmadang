...
/**
 * 메세지 식별자 NotExist06 비지니스 로직
 * 
 * @author Jonghoon Won
 * 
 */
public final class NotExist06SExtor extends AbstractServerExecutor {
	...
	protected void doTask(CommonProjectInfo commonProjectInfo,
		...
		OutputMessage outObj = messageManger.createOutputMessage("NotExist06");
