...
<li>
	<dl>
			<dt>신놀이 프레임 워크란?</dt>
			<dd> 신놀이 프레임 워크는 아래 2가지 요소(신놀이 서버, 클라이언트 서버 접속 라이브러리)로 구성되어 있다.<br/>
			이 프레임 워크를 활용한 예를 파일 송수신 서버/클라이언트가 있다.<br/><br/>
			
			유사한 형태로써 작은 Netty + 작은 구글 Protocol Buffers 조합이라고 할 수 있다. <br/><br/>
			
			Netty 는 TCP/IP,  UDP 등 매우 확장성 있는 네트워크 프레임 워크이다.<br/> 			
			반면 신놀이는 TCP/IP 만 지원하고 있다.<br/><br/>
			
			Protocol Buffers 는 매우 많은 언어를 지원하지만 신놀이는 오직 자바만 지원하고 있다.<br/>&nbsp;
			</dd>
	</dl>
	<ol>
	<li>
