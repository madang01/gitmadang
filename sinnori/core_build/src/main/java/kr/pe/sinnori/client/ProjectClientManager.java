 ...
 * 
 */
public final class ProjectClientManager {
	private Logger log = LoggerFactory.getLogger(ProjectClientManager.class);
	...
	private static final class ClientProjectManagerHolder {
		static final ProjectClientManager singleton = new ProjectClientManager();
	}

	/** 동기화 쓰지 않는 싱글턴 구현 메소드 */
	public static ProjectClientManager getInstance() {
