...
public abstract class AbstractServerTask {
	...
	public void execute(int index, 
		...
		try {
			...
			try {
				messageFromClient = messageDecoder.decode(messageProtocol.getSingleItemDecoder(), charsetOfProject, receivedLetter.getMiddleReadObj());
		...
		LetterSender letterSender = new LetterSender(this, clientResource, messageFromClient, 
				charsetOfProject, ouputMessageQueue, messageProtocol, serverObjectCacheManager);
	...
	public List<WrapBuffer> getMessageStream(String messageIDFromClient, 
			SocketChannel toSC, 
