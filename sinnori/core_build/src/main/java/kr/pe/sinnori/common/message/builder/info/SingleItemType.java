...
public enum SingleItemType {
	...
	UB_VARIABLE_LENGTH_BYTE(11, "ub variable length byte[]"),
	US_VARIABLE_LENGTH_BYTE(12, "us variable length byte[]"),
	SI_VARIABLE_LENGTH_BYTE(13, "si variable length byte[]"),
	UI_VARIABLE_LENGTH_BYTE(14, "fixed length byte[]"),
