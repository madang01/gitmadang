...
public class MainProjectManagerPanel extends JPanel {
	...
	public MainProjectManagerPanel(Frame mainFrame, MainProjectManagerWindowManagerIF mainProjectManagerWindowManager) {
	...
	public void setScreen(String sinnoriInstalledPathString, List<String> mainProjectNameList) {				
	...
	private void mainProjectEditButtonActionPerformed(ActionEvent e) {
		if (mainProjectNameListComboBox.getSelectedIndex() > 0) {
			...
			try {
				mainProjectBuildSystemState = new MainProjectBuildSystemState(mainProjectName, sinnoriInstalledPathString);
			...
			mainProjectManagerWindowManager.goMainProjectEditScreen(mainProjectBuildSystemState);
		}
	}
	...
	private void mainProjectNameDeleteButtonActionPerformed(ActionEvent e) {
		...
		int answer = JOptionPane.showConfirmDialog(mainFrame, message, title, JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE);
	...
	private void initComponents() {
		...
		//======== allProjectWorkSaveLinePanel ========
		{
			...
			allProjectWorkSaveLinePanel.add(mainProjecNameListUpdatetButton);
		}
