...
public final class SyncMailboxForAsynPrivate implements SyncMailboxIF {
	private InternalLogger log = InternalLoggerFactory.getInstance(SyncMailboxForAsynPrivate.class);
	...
	public SyncMailboxForAsynPrivate(int mailboxID, long socketTimeOut) {
		if (0 == mailboxID) {
	...
	public String toString() {
		...
		builder.append("SyncMailboxForAsynPrivate [mailboxID=");
