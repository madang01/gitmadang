...
public class MessageProcessFileContentsManager {
	...
	private static final class MessageProcessFileContentsManagerHolder {
		static final MessageProcessFileContentsManager singleton = new MessageProcessFileContentsManager();
	}

	/** 동기화 쓰지 않는 싱글턴 구현 메소드 */
	public static MessageProcessFileContentsManager getInstance() {
	 ...
	 */
	private MessageProcessFileContentsManager() {
