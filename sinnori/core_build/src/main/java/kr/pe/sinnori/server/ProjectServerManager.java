...
public final class ProjectServerManager {
	private Logger log = LoggerFactory.getLogger(ProjectServerManager.class);
	...
	private static final class MainProjectServerManagerHolder {
		static final ProjectServerManager singleton = new ProjectServerManager();
	}

	/** 동기화 쓰지 않는 싱글턴 구현 메소드 */
	public static ProjectServerManager getInstance() {
	 ...
	 */
	public AnyProjectServer getRunningSubProjectServer(String subProjectName) throws NotFoundProjectException {
	...
	public AnyProjectServer getRunningMainProjectServer() throws NotFoundProjectException {
