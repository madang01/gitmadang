...
public class MessageInfoTableModelForProject extends DefaultTableModel {
	private Object values[][] = null;
	private String titles[] = null;	
	private Class<?>[] columnTypes = null;
	
	public MessageInfoTableModelForProject(Object values[][], String titles[], Class<?>[] columnTypes) {
		super(values, titles);
		this.values = values;
		this.titles = titles;
