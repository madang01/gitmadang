...
public class MessageInfoSAXParserTest {
	...
	public void testGetMessageIDFromXMLFilePathString_NullParameter_xmlFilePathString() {
		String expectedMessage = "the parameter xmlFilePathString is null";
	...
	public void testGetMessageIDFromXMLFilePathString_EmptyString_xmlFilePathString() {
		String expectedMessage = "the parameter xmlFilePathString is a empty string";
	...
	public void testGetMessageIDFromXMLFilePathString_ValidButBadParameter_xmlFilePathString_xml확장자보다작은경우() {
		String testTitle = "xml 확장자 보다 작은 경우";
		String xmlFilePathString = "a";
		String expectedMessage = String
				.format("the parameter xmlFilePathString[%s] is less than or equal to the string '.xml' length",
						xmlFilePathString);
		try {
			messageInfoSAXParser
					.getMessageIDFromXMLFilePathString(xmlFilePathString);
	...
	public void testGetMessageIDFromXMLFilePathString_ValidButBadParameter_xmlFilePathString_xml확장자와같은경우() {
		String testTitle = "xml 확장자와 같은 경우";
	...
	public void testGetMessageIDFromXMLFilePathString_ValidButBadParameter_xmlFilePathString_잘못된메시지식별자를파일명으로가지는xml확장자파일명() {
		...
		String expectedMessage = String
				.format("the parameter xmlFilePathString[%s] is the '<messageID>.xml' format file name having invalid message id[%s]",
	...
	@Test
	public void testGetMessageIDFromXMLFilePathString_ValidButBadParameter_xmlFilePathString_부모경로를갖지만메시지식별자가없고xml확장자를갖는파일명() {
		String testTitle = "부모 경로를 갖지만 메시지 식별자가 없고 xml 확장자를 갖는 파일명";
		String xmlFilePathString = File.separator + ".xml";
		String expectedMessage = String
				.format("fail to get message id from the parameter xmlFilePathString[%s] that is '<messageID>.xml' format file name",
						xmlFilePathString);
		try {
			messageInfoSAXParser
					.getMessageIDFromXMLFilePathString(xmlFilePathString);
	...
	public void testGetMessageIDFromXMLFilePathString_ValidButBadParameter_xmlFilePathString_xml확장자를갖지않는파일명() {
		...
		String expectedMessage = String.format(
				"the parameter xmlFilePathString[%s])'s suffix is not '.xml'",
				xmlFilePathString);
		try {
			messageInfoSAXParser
					.getMessageIDFromXMLFilePathString(xmlFilePathString);
	 ...
	 */
	private String getMessageInfoTestDataXmlFileFullPathString(
	...
	public void testParse_ok() {
		...
		File xmlFile = new File(getMessageInfoTestDataXmlFileFullPathString(
	...
	public void testParse_XSLRuleError_단일항목_2번중복되는이름속성() {
		...
		File xmlFile = new File(
				getMessageInfoTestDataXmlFileFullPathString(
	...
	public void testParse_재사용하여반복사용가능한지여부판단을위한여러번호출() {
		...
		while (true) {
			...
			String messageIDTagValue = "IAmNotBadMessageID";
			String messageIDOfFileName = "BadMessageID";
			xmlFile = new File(getMessageInfoTestDataXmlFileFullPathString(
					sinnoriInstalledPathString, messageIDOfFileName + ".xml"));
