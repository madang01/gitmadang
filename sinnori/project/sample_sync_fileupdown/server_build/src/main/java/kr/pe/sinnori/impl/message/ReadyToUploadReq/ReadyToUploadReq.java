...
/**
 * ReadyToUploadReq 메시지
 * @author Won Jonghoon
 *
 */
public class ReadyToUploadReq extends AbstractMessage {
	private byte whetherToAppend;
	...
	public byte getWhetherToAppend() {
		return whetherToAppend;
	}

	public void setWhetherToAppend(byte whetherToAppend) {
		this.whetherToAppend = whetherToAppend;
	}
	...
	public String toString() {
		...
		builder.append("class ReadyToUploadReq[");
		builder.append("whetherToAppend=");
		builder.append(whetherToAppend);
