 ...
 *
 */
public final class LoginResClientCodec implements MessageCodecIF {

	@Override
	public AbstractMessageDecoder getMessageDecoder() throws DynamicClassCallException {
		return new LoginResDecoder();
	}

	@Override
	public AbstractMessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("LoginRes메시지는 클라이언트에서 서버로 전달하지 않는 메시지 입니다.");
	}
}