...
/**
 * FileListRes 클라이언트 코덱
 * @author Won Jonghoon
 *
 */
public final class FileListResClientCodec implements MessageCodecIF {

	@Override
	public AbstractMessageDecoder getMessageDecoder() throws DynamicClassCallException {
		return new FileListResDecoder();
	}

	@Override
	public AbstractMessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("FileListRes메시지는 클라이언트에서 서버로 전달하지 않는 메시지 입니다.");
	}
}