...
public final class BoardVoteInDTOEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		BoardVoteReq boardVoteInDTO = (BoardVoteReq)messageObj;
		encodeBody(boardVoteInDTO, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BoardVoteReq boardVoteInDTO, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
