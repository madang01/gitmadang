...
public final class BigIntEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		...
		encodeBody(bigInt, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BigInt bigInt, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
