...
public final class BoardWriteInDTOEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		BoardWriteReq boardWriteInDTO = (BoardWriteReq)messageObj;
		encodeBody(boardWriteInDTO, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BoardWriteReq boardWriteInDTO, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
