...
/**
 * BoardVoteInDTO 메시지 디코더
 * @author Won Jonghoon
 *
 */
public final class BoardVoteInDTODecoder extends AbstractMessageDecoder {

	/**
	 * <pre>
	 *  "단일항목 디코더"를 이용하여 "중간 다리 역활 읽기 객체" 에서 추출된 BoardVoteInDTO 메시지를 반환한다.
	 * </pre>
	 * @param singleItemDecoder 단일항목 디코더
	 * @param charsetOfProject 프로젝트 문자셋
	 * @param middleReadObj 중간 다리 역활 읽기 객체
	 * @return "단일항목 디코더"를 이용하여 "중간 다리 역활 읽기 객체" 에서 추출된 BoardVoteInDTO 메시지
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Charset charsetOfProject, Object  middleReadObj) throws OutOfMemoryError, BodyFormatException {
		BoardVoteInDTO boardVoteInDTO = new BoardVoteInDTO();
		String sigleItemPath0 = "BoardVoteInDTO";

		boardVoteInDTO.setBoardId((Long)
		...
		boardVoteInDTO.setBoardNo((Long)
		singleItemDecoder.getValueFromMiddleReadObj(sigleItemPath0
		, "boardNo" // itemName
		, 5 // itemTypeID
		, "unsigned integer" // itemTypeName
		...
		boardVoteInDTO.setUserId((String)
		singleItemDecoder.getValueFromMiddleReadObj(sigleItemPath0
		, "userId" // itemName
		, 7 // itemTypeID
