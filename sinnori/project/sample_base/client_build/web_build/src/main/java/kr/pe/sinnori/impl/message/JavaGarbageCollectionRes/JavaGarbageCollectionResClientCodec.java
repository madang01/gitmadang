...
/**
 * JavaGarbageCollectionRes 클라이언트 코덱
 * @author Won Jonghoon
 *
 */
public final class JavaGarbageCollectionResClientCodec implements MessageCodecIF {
	...
	public AbstractMessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("the client don't need a message encoder because it is a message[JavaGarbageCollectionRes] that is not sent from client to server");
	}
}