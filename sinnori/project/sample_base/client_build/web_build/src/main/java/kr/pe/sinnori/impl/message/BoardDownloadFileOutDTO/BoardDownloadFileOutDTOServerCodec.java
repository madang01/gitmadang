...
public final class BoardDownloadFileOutDTOServerCodec implements MessageCodecIF {
	...
	public AbstractMessageDecoder getMessageDecoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("the server don't need a message decoder because it is a message[BoardDownloadFileOutDTO] that is not sent from client to server");
	}
