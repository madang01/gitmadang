 ...
 *
 */
public final class BigShortEncoder extends AbstractMessageEncoder {
	@Override
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		BigShort bigShort = (BigShort)messageObj;
		encodeBody(bigShort, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BigShort bigShort, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
		java.util.LinkedList<String> pathStack = new java.util.LinkedList<String>();
		pathStack.push("BigShort");
