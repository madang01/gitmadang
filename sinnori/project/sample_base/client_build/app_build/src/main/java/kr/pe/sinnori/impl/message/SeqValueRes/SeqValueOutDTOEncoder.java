...
public final class SeqValueOutDTOEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		SeqValueRes seqValueOutDTO = (SeqValueRes)messageObj;
		encodeBody(seqValueOutDTO, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(SeqValueRes seqValueOutDTO, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
