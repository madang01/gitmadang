 ...
 *
 */
public final class BigUByteEncoder extends AbstractMessageEncoder {
	@Override
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		BigUByte bigUByte = (BigUByte)messageObj;
		encodeBody(bigUByte, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BigUByte bigUByte, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
