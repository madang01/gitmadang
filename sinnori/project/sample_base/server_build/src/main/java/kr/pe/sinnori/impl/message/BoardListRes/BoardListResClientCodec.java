...
public final class BoardListResClientCodec implements MessageCodecIF {
	...
	public AbstractMessageDecoder getMessageDecoder() throws DynamicClassCallException {
		return new BoardListResDecoder();
	}

	@Override
	public AbstractMessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("the client don't need a message encoder because it is a message[BoardListRes] that is not sent from client to server");
	}
}