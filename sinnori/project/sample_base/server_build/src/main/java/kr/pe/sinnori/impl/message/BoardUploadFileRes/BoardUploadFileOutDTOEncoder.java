...
public final class BoardUploadFileOutDTOEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		BoardUploadFileRes boardUploadFileOutDTO = (BoardUploadFileRes)messageObj;
		encodeBody(boardUploadFileOutDTO, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BoardUploadFileRes boardUploadFileOutDTO, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
		...
		java.util.List<BoardUploadFileRes.AttachFile> attachFile$2List = boardUploadFileOutDTO.getAttachFileList();
