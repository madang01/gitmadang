 ...
 *
 */
public final class BigUIntEncoder extends AbstractMessageEncoder {
	@Override
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		BigUInt bigUInt = (BigUInt)messageObj;
		encodeBody(bigUInt, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BigUInt bigUInt, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
		java.util.LinkedList<String> pathStack = new java.util.LinkedList<String>();
		pathStack.push("BigUInt");
