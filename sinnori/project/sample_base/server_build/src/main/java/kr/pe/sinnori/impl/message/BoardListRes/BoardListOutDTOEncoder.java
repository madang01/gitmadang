...
public final class BoardListOutDTOEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		BoardListRes boardListOutDTO = (BoardListRes)messageObj;
		encodeBody(boardListOutDTO, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BoardListRes boardListOutDTO, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
		...
		java.util.List<BoardListRes.Board> board$2List = boardListOutDTO.getBoardList();
