...
public final class BoardListInDTOEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		BoardListReq boardListInDTO = (BoardListReq)messageObj;
		encodeBody(boardListInDTO, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(BoardListReq boardListInDTO, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
