...
public final class MemberRegisterWithSessionKeyEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		MemberRegisterReq memberRegisterWithSessionKey = (MemberRegisterReq)messageObj;
		encodeBody(memberRegisterWithSessionKey, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(MemberRegisterReq memberRegisterWithSessionKey, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
