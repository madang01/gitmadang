...
/**
 * BoardModifyInDTO 메시지 디코더
 * @author Won Jonghoon
 *
 */
public final class BoardModifyInDTODecoder extends AbstractMessageDecoder {

	/**
	 * <pre>
	 *  "단일항목 디코더"를 이용하여 "중간 다리 역활 읽기 객체" 에서 추출된 BoardModifyInDTO 메시지를 반환한다.
	 * </pre>
	 * @param singleItemDecoder 단일항목 디코더
	 * @param charsetOfProject 프로젝트 문자셋
	 * @param middleReadObj 중간 다리 역활 읽기 객체
	 * @return "단일항목 디코더"를 이용하여 "중간 다리 역활 읽기 객체" 에서 추출된 BoardModifyInDTO 메시지
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Charset charsetOfProject, Object  middleReadObj) throws OutOfMemoryError, BodyFormatException {
		BoardModifyInDTO boardModifyInDTO = new BoardModifyInDTO();
		String sigleItemPath0 = "BoardModifyInDTO";

		boardModifyInDTO.setBoardId((Long)
		...
		boardModifyInDTO.setBoardNo((Long)
		singleItemDecoder.getValueFromMiddleReadObj(sigleItemPath0
		, "boardNo" // itemName
		, 5 // itemTypeID
		, "unsigned integer" // itemTypeName
		...
		boardModifyInDTO.setSubject((String)
		singleItemDecoder.getValueFromMiddleReadObj(sigleItemPath0
		, "subject" // itemName
		, 8 // itemTypeID
		...
		boardModifyInDTO.setContent((String)
		singleItemDecoder.getValueFromMiddleReadObj(sigleItemPath0
		, "content" // itemName
		, 9 // itemTypeID
