...
/**
 * DownFileDataResult 클라이언트 코덱
 * @author Won Jonghoon
 *
 */
public final class DownFileDataResultClientCodec implements MessageCodecIF {

	@Override
	public MessageDecoder getMessageDecoder() throws DynamicClassCallException {
		return new DownFileDataResultDecoder();
	}

	@Override
	public MessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("DownFileDataResult메시지는 클라이언트에서 서버로 전달하지 않는 메시지 입니다.");
	}
}