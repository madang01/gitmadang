...
public class AsynUploadSwingAction extends AbstractAction {
	private Logger log = LoggerFactory.getLogger(AsynUploadSwingAction.class);
	 ...
	 */
	public AsynUploadSwingAction(JFrame mainFrame,
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			UpFileInfoResult upFileInfoResulOutObj = mainController
			...
			serverTargetFileID = upFileInfoResulOutObj.getServerTargetFileID();
