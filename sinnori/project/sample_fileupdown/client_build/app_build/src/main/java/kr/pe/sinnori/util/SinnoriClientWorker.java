...
public class SinnoriClientWorker {
	...
	private static final class SinnoriWorkerHolder {
		static final SinnoriClientWorker singleton = new SinnoriClientWorker();
	}

	/**
	 * 동기화 쓰지 않는 싱글턴 구현 메소드
	 */
	public static SinnoriClientWorker getInstance() {
	...
	private String getClientExecetorClassName(String clinetExecutorName) {		
		...
		strBuilder.append(ClientCommonStaticFinalVars.CLIENT_EXECUTOR_PREFIX);
		strBuilder.append(clinetExecutorName);
		strBuilder.append(ClientCommonStaticFinalVars.CLIENT_EXECUTOR_SUFFIX);
