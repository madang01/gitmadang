...
import kr.pe.sinnori.gui.screen.syncfileupdownscreen.action.SyncDownloadSwingAction;
...
public class SyncFileUpDownScreen extends JPanel implements FileUpDownScreenIF {
	 ...
	 * Create the panel.
	 */
	public SyncFileUpDownScreen(final JFrame mainFrame, MainControllerIF mainController) {
		...
		SyncUploadSwingAction uploadAction = new SyncUploadSwingAction(this.mainFrame, mainController, this, localTree, localRootNode, remoteTree, remoteRootNode, remotePathSeperator);
		uploadAction.putValue(AbstractAction.NAME, uploadButton.getText());
		uploadButton.setAction(uploadAction);
		
		SyncDownloadSwingAction downloadAction = new SyncDownloadSwingAction(this.mainFrame, mainController, this, localTree, localRootNode, remoteTree, remoteRootNode, remotePathSeperator);
	...
	public void init() {
		/*FileListResult fileListOutObj = this.mainController
				.getRemoteFileList(".");
