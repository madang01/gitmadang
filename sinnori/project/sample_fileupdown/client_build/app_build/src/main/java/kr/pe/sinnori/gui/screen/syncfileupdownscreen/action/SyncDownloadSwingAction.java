...
package kr.pe.sinnori.gui.screen.syncfileupdownscreen.action;
...
public class SyncDownloadSwingAction extends AbstractAction {
	private Logger log = LoggerFactory.getLogger(SyncDownloadSwingAction.class);
	 ...
	 */
	public SyncDownloadSwingAction(JFrame mainFrame,
	...
	public void actionPerformed(ActionEvent e) {
		...
		DownFileInfoResult downFileInfoResultOutObj = mainController.readyDownloadFile(append, 
