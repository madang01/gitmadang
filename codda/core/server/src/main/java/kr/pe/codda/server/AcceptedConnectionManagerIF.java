 ...
 *
 */
public interface AcceptedConnectionManagerIF {	
	public void addNewAcceptedSocketChannel(SocketChannel sc) throws NoMoreDataPacketBufferException, InterruptedException;
