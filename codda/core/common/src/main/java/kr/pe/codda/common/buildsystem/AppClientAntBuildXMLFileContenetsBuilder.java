...
public class AppClientAntBuildXMLFileContenetsBuilder extends AbstractAntBuildXMLContentsBuilder {
	public static String build(String mainProjectName) {
		final String builderProjectName = new StringBuilder().append(mainProjectName)
				.append("_appclient").toString();
		final String defaultTargetName = "make.main.only";
		...
		addNewLine(contentsStringBuilder);
		addOnlyCompileMainTargetPart(contentsStringBuilder, depth);
		
		addNewLine(contentsStringBuilder);
		addOnlyMakeMainPart(contentsStringBuilder, depth);
	...
	public static void addJunitTestTargetPart(StringBuilder contentsStringBuilder, int depth) {
		...
		addAttribute(contentsStringBuilder, "file", "${dir.dist}/${appclient.main.jar.name}");
		contentsStringBuilder.append(" />");
	...
	public static void addOnlyMakeMainPart(StringBuilder contentsStringBuilder, int depth) {
		addNewLine(contentsStringBuilder);
		CommonStaticUtil.addPrefixWithTabCharacters(contentsStringBuilder, depth, 1);
		contentsStringBuilder.append("<target");
		addAttribute(contentsStringBuilder, "name", "make.main.only");
		addAttribute(contentsStringBuilder, "depends", "compile.main.only");
		contentsStringBuilder.append(">");
		
		addMainJarPart(contentsStringBuilder, depth);
	...
	public static void addOnlyCompileMainTargetPart(StringBuilder contentsStringBuilder, int depth) {
		addNewLine(contentsStringBuilder);
		CommonStaticUtil.addPrefixWithTabCharacters(contentsStringBuilder, depth, 1);
		contentsStringBuilder.append("<target");
		addAttribute(contentsStringBuilder, "name", "compile.main.only");
		...
		addMainJavaCompilePart(contentsStringBuilder, depth);
	...
	private static void addMainJarPart(StringBuilder contentsStringBuilder, int depth) {
		addNewLine(contentsStringBuilder);
		CommonStaticUtil.addPrefixWithTabCharacters(contentsStringBuilder, depth, 2);
		contentsStringBuilder.append("<jar");
		addAttribute(contentsStringBuilder, "destfile", "${dir.dist}/${appclient.main.jar.name}");
		...
		addAttribute(contentsStringBuilder, "value", "${appclient.main.class.name}");
		contentsStringBuilder.append(" />");
	...
	private static void addMainJavaCompilePart(StringBuilder contentsStringBuilder, int depth) {
		addNewLine(contentsStringBuilder);
		CommonStaticUtil.addPrefixWithTabCharacters(contentsStringBuilder, depth, 2);
		contentsStringBuilder.append("<javac");
		addAttribute(contentsStringBuilder, "debug", "${java.complile.option.debug}");
	...
	private static void addProprtiesPart(final int depth, StringBuilder contentsStringBuilder) {
		...
		addNewLine(contentsStringBuilder);		
		CommonStaticUtil.addPrefixWithTabCharacters(contentsStringBuilder, depth, 1);
		addPropertyTag(contentsStringBuilder, "appclient.main.class.name", "value", CommonStaticFinalVars.APPCLIENT_MAIN_CLASS_FULL_NAME_VALUE);
		
		addNewLine(contentsStringBuilder);		
		CommonStaticUtil.addPrefixWithTabCharacters(contentsStringBuilder, depth, 1);
		addPropertyTag(contentsStringBuilder, "appclient.main.jar.name", "value", CommonStaticFinalVars.APPCLIENT_EXECUTABLE_JAR_SHORT_FILE_NAME_VALUE);
