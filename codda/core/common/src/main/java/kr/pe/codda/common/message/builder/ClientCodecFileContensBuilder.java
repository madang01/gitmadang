...
public class ClientCodecFileContensBuilder extends AbstractSourceFileBuildre {
	...
	public String buildStringOfFileContents(
		...
		switch (messageTransferDirectionType) {
			...
			default: {
				/** 디코더가 필요 없는 경우 */
				contetnsStringBuilder.append("throw new DynamicClassCallException(\"the client don't need a message decoder because it is a message[");
				contetnsStringBuilder.append(messageID);
		...
		switch (messageTransferDirectionType) {
			...
			default: {
				/** 디코더가 필요 없는 경우 */
				contetnsStringBuilder.append("throw new DynamicClassCallException(\"the client don't need a message encoder because it is a message[");
				contetnsStringBuilder.append(messageID);
