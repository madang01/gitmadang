...
public class Configuration {
	private InternalLogger log = InternalLoggerFactory.getInstance(Configuration.class);
	...
	public Configuration(String sinnoriInstalledPathString,
			String mainProjectName) throws IllegalArgumentException, ConfigurationException, FileNotFoundException, IOException {
	...
	public void convertSinnoriConfigSequencedPropertiesToAllPartItemsWithValidation(SequencedProperties sinnoriConfigSequencedProperties) throws ConfigurationException {		
		...
		for (String dbcpName : dbcpNameList) {
			...
			for (ItemIDInfo<?> itemIDInfo : dbcpItemIDInfoList) {
				...
				boolean isInactive = sinnoriItemIDInfoManger.isDisabled(itemID,
	...
	private void overwriteFile() throws IOException {		
		SequencedPropertiesUtil.overwriteSequencedPropertiesFile(sinnoriConfigSequencedProperties,
				getSinnoriConfigPropertiesTitle(), sinnoriConfigFilePathString, CommonStaticFinalVars.SOURCE_FILE_CHARSET);
	}
	
	public void applyModifiedSinnoriConfigSequencedProperties() throws IOException, ConfigurationException {
		initAllPartItems(mainProjectName);
	...
	// FIXME!
	public static void applySinnoriInstalledPath(String sinnoriInstalledPathString, String mainProjectName) throws IOException, ConfigurationException {
		...
		SequencedPropertiesUtil.overwriteSequencedPropertiesFile(sinnoriConfigSequencedProperties,
				getSinnoriConfigPropertiesTitle(mainProjectName), sinnoriConfigFilePathString, CommonStaticFinalVars.SOURCE_FILE_CHARSET);
		
	}

	private static List<String> buildDBCPNameList(String sinnoriConfigFilePathString,
			SequencedProperties sinnoriConfigSequencedProperties) throws ConfigurationException {
		List<String> dbcpNameList = new ArrayList<>();
		Set<String> dbcpNameSet = new HashSet<>();		
		{
			String itemValue = sinnoriConfigSequencedProperties
