...
import kr.pe.codda.common.logback.SinnoriLogbackManger;
...
public abstract class AbstractJunitTest {
	...
	@BeforeClass
	 public static void setUpBeforeClass() throws Exception {
		...
		String sinnoriInstalledPathString = new StringBuilder(installedBasePath.getAbsolutePath())
		.append(File.separator)
		.append(CommonStaticFinalVars.ROOT_PROJECT_NAME).toString();
				
		installedPath = new File(sinnoriInstalledPathString);
