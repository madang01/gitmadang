...
public class WebClientAntBuildXMLFileContenetsBuilderTest extends AbstractJunitTest {
	...
	public void testBuild_isEqualToSampleBaseWebClientAntBuildXMLFile() {
		...
		String appClientAntBuildXMLFilePathString = BuildSystemPathSupporter.getWebClientAntBuildXMLFilePathString(installedPath.getAbsolutePath(), mainProjectName);
