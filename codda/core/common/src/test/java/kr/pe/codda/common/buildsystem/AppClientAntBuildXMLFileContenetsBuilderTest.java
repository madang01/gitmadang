...
public class AppClientAntBuildXMLFileContenetsBuilderTest extends AbstractJunitTest {
	...
	public void testBuild_isEqualToSampleBaseAppClientAntBuildXMLFile() {
		...
		String appClientAntBuildXMLFilePathString = BuildSystemPathSupporter.getAppClientAntBuildXMLFilePathString(installedPath.getAbsolutePath(), mainProjectName);
