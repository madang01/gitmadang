...
public final class SyncMailboxForAsynNoShare implements SyncMailboxIF {
	private InternalLogger log = InternalLoggerFactory.getInstance(SyncMailboxForAsynNoShare.class);
	...
	private AsynNoShareConnection conn;
	...
	public SyncMailboxForAsynNoShare(AsynNoShareConnection conn, int mailboxID, long socketTimeOut) {
		if (0 == mailboxID) {
