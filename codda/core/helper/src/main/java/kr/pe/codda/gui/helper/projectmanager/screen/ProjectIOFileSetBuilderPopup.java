...
import kr.pe.codda.gui.helper.iobuilder.screen.FileFunctionManagerIF;
import kr.pe.codda.gui.helper.projectmanager.table.messageinfo.BuildFunctionCellEditorForProject;
import kr.pe.codda.gui.helper.projectmanager.table.messageinfo.BuildFunctionCellRendererForProject;
import kr.pe.codda.gui.helper.projectmanager.table.messageinfo.BuildFunctionCellValueForProject;
import kr.pe.codda.gui.helper.projectmanager.table.messageinfo.FileFunctionCellEditorForProject;
import kr.pe.codda.gui.helper.projectmanager.table.messageinfo.FileFunctionCellRendererForProject;
import kr.pe.codda.gui.helper.projectmanager.table.messageinfo.FileFunctionCellValueForProject;
import kr.pe.codda.gui.helper.projectmanager.table.messageinfo.MessageInfoTableModelForProject;
...
public class ProjectIOFileSetBuilderPopup extends JDialog implements FileFunctionManagerIF, BuildFunctionManagerIF {
			...
			if (isSelectedIO) {
				...
				try {
					CommonStaticUtil.saveFile(messageFile, ioFileSetContentsBuilderManager.getMessageSourceFileContents(
							 author, messageInfo), CommonStaticFinalVars.SOURCE_FILE_CHARSET);
				} catch (IOException e) {
	...
	public boolean saveIOFileSetOfSelectedMessageInfo(boolean isSelectedIO, boolean isSelectedDirection,
		...
		String messageInfoSourcePathString = BuildSystemPathSupporter.getProjectMessageInfoDirectoryPathString(sinnoriInstalledPathString, mainProjectName);
		...
		if (isOtherMainProjectCheckBox.isSelected()) {
			...
			String messageInfoTargetPathString = BuildSystemPathSupporter.getProjectMessageInfoDirectoryPathString(sinnoriInstalledPathString, targetProjectName);
