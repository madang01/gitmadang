...
public final class BoardWriteReqServerCodec implements MessageCodecIF {
	...
	private AbstractMessageDecoder messageDecoder = new BoardWriteReqDecoder();
	...
	public AbstractMessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("the server don't need a message encoder because it is a message[BoardWriteReq] that is not sent from server to client");
	}
}