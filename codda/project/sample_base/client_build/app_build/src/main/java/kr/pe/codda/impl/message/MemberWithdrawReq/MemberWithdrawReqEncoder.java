...
public final class MemberWithdrawReqEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object writableMiddleObject) throws Exception {
		...
		encodeBody(memberWithdrawReq, singleItemEncoder, writableMiddleObject);
	}


	private void encodeBody(MemberWithdrawReq memberWithdrawReq, SingleItemEncoderIF singleItemEncoder, Object middleWritableObject) throws Exception {
