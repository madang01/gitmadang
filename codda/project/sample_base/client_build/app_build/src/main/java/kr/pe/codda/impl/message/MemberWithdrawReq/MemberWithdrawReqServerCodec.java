...
/**
 * MemberWithdrawReq server codec
 * @author Won Jonghoon
 *
 */
public final class MemberWithdrawReqServerCodec implements MessageCodecIF {
	...
	public AbstractMessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("the server don't need a message encoder because it is a message[MemberWithdrawReq] that is not sent from server to client");
	}
}