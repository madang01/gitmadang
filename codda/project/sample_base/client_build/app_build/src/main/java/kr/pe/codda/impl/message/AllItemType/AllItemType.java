...
public class AllItemType extends AbstractMessage {
	...
	public String toString() {
		...
		builder.append(kr.pe.codda.common.util.HexUtil.getHexStringFromByteArray(bytesVar1, 0, Math.min(bytesVar1.length, 7)));
		builder.append(", bytesVar2=");
		builder.append(kr.pe.codda.common.util.HexUtil.getHexStringFromByteArray(bytesVar2, 0, Math.min(bytesVar2.length, 7)));
