...
public class UserLoginProcessSvl extends AbstractServlet {
	 ...
	 * HttpServletResponse res, ServerSymmetricKeyIF webServerSymmetricKey, String
	 * modulusHexString, String errorMessage) {
	 * req.setAttribute(WebCommonStaticFinalVars
	 * .REQUEST_KEY_NAME_OF_WEB_SERVER_SYMMETRIC_KEY, webServerSymmetricKey); req
	...
	protected void performTask(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		synchronized (req) {
			...
			if (null == clientSessionKey) {
				...
				clientSessionKey = ClientSessionKeyManager.getInstance().getNewClientSessionKey(binaryPublicKeyBytes,
						false);
