...
/**
 * UserInformationRes message decoder
 * @author Won Jonghoon
 *
 */
public final class UserInformationResDecoder extends AbstractMessageDecoder {
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Object  middleReadableObject) throws BodyFormatException {
		...
		userInformationRes.setNickname((String)
		...
		userInformationRes.setPasswordHint((String)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
		...
		userInformationRes.setPasswordAnswer((String)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
		...
		userInformationRes.setPasswordFailedCount((Short)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
		...
		userInformationRes.setIp((String)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
			, "ip" // itemName
			, kr.pe.codda.common.type.SingleItemType.UB_PASCAL_STRING // itemType
			, -1 // itemSize
		...
		userInformationRes.setRegisteredDate((java.sql.Timestamp)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
		...
		userInformationRes.setLastModifiedDate((java.sql.Timestamp)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
