...
/**
 * BoardDetailRes client codec
 * @author Won Jonghoon
 *
 */
public final class BoardDetailResClientCodec implements MessageCodecIF {

	private AbstractMessageDecoder messageDecoder = new BoardDetailResDecoder();
