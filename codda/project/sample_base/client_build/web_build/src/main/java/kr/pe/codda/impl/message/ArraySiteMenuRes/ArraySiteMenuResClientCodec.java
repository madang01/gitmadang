...
public final class ArraySiteMenuResClientCodec implements MessageCodecIF {
	...
	public AbstractMessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("the client don't need a message encoder because it is a message[ArraySiteMenuRes] that is not sent from client to server");
	}
}