...
public class AdminSiteMenuManger {
	...
	private AdminSiteMenuManger() {
		topSiteMenuInfoList.add(new SiteMenuInfo(1, "메뉴 관리", new SiteURLInfo("/servlet/MenuManagement")));
		topSiteMenuInfoList.add(new SiteMenuInfo(2, "사용자 관리", new SiteURLInfo("/servlet/UserManagement")));
		topSiteMenuInfoList.add(new SiteMenuInfo(3, "사용자별 메뉴 권한 설정", new SiteURLInfo("/servlet/PagePermissionSetting")));
	}
