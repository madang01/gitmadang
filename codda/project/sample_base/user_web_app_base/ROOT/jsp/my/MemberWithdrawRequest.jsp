...
<script type='text/javascript'>	
	...
	function callBackForMemberWithdrawProcess() {
		...
		resultMessageDiv.innerHTML = "<strong>Success!</strong> " + userNameDiv.innerText + " 님 회원 탈퇴 처리가 완료되었습니다";
	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading"><h4><%= StringEscapeActorUtil.replace(accessedUserformation.getUserName(), 
					StringEscapeActorUtil.STRING_REPLACEMENT_ACTOR_TYPE.ESCAPEHTML4) %> 님의 회원 탈퇴</h4></div>
			<div class="panel-body">
				...
				<form method="post" name="gofrm" target="hiddenFrame" action="/servlet/MemberWithdrawProcess">
				...
				<br>
				<form method="post" name="frm" onsubmit="goMemberWithdraw(); return false;">
