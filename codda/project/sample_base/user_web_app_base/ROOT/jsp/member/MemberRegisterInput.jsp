...
<script type='text/javascript'>
	...
	function callBackForMembershipProcess() {
		...
		document.location.href = "/servlet/MemberLoginInput?userID="+document.frm.userID.value;
	}
	...
	<div class="content">
		<div class="container">
			<div class="panel panel-default">
				<div class="panel-heading"><h4>일반 회원 가입</h4></div>
				<div class="panel-body">
					...
					<form method="post" name="frm" onsubmit="goMemberRegister(); return false;">
						...
						<div class="form-group">
							...
							<input type="email" id="email" class="form-control" name="email" maxlength="350">
						</div>
						<div class="form-group">
