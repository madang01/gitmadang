	...
	<div id="contentbody">
		<table border="1">
			...
			<tr>
				...
				<td style="text-align:left;"><%=HtmlStringUtil.toHtml4BRString(javascriptMDHex, 68)%></td> 
			</tr>
			<tr>
				<td>server Diagst Message</td>
				<td style="text-align:left;"><%=HtmlStringUtil.toHtml4BRString(serverMDHex, 68)%></td> 
			</tr>
			<tr>
				<td>비교결과</td>
