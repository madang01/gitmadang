...
<h1><%= BoardType.valueOf(Short.parseShort(parmBoardId)).getName() %> 게시판 - 수정 하기</h1>
<br/>
...
<form name=frm onSubmit="return false">
	<div>
		...
		<li>
			<dl>
				<dt>제목</dt>
				<dd><input type="text" name="subject" size="50" value="<%=HtmlStringUtil.toHtml4BRString(boardDetailRes.getSubject())%>" /></dd>
			</dl>
		</li>
		<li>
			<dl>
				<dt>내용</dt>
				<dd><textarea name="content" style="width: 500px; height: 220px;"><%=HtmlStringUtil.toHtml4String(boardDetailRes.getContent())%></textarea></dd>
			</dl>
		</li>
		<li>
			<dl>
...
<form name="attachForm" target="uploadResultFrame" action="/servlet/BoardUpload" method="post" enctype="multipart/form-data">
	<input type="hidden" name="attachId" value="<%=boardDetailRes.getAttachId()%>" />
