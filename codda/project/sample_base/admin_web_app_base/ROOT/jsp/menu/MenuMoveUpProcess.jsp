...
<script type='text/javascript'>
	function init() {		
		if (parent != null && parent.callBackForMenuMoveUpProcess != null) {
			parent.callBackForMenuMoveUpProcess();
		} else {
			alert("parent.callBackForMenuMoveUpProcess 이 존재하지 않습니다");
		}
	}
	window.onload = init;
</script>
