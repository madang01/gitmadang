...
<script type='text/javascript'>
	function init() {		
		if (parent != null && parent.callBackForRootMenuAdditionProcess != null) {
			var rootMenuAddRes = <%= new Gson().toJson(rootMenuAddRes) %>;
			parent.callBackForRootMenuAdditionProcess(rootMenuAddRes);
		} else {
			alert("parent.callBackForRootMenuAdditionProcess 이 존재하지 않습니다");
		}
	}
	window.onload = init;
</script>
