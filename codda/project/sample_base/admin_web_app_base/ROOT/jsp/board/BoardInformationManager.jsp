...
<script type='text/javascript'>
	...
	function reload() {
		document.location.href = "/servlet/BoardInformationManager"; 
	}
		...
		<div class="container">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form name="addBoardInfoFrm" method="post" action="/servlet/BoardInformationAdd" target="hiddenFrame">
					...
					<form name="deleteBoardInfoFrm" method="post" action="/servlet/BoardInformationDelete" target="hiddenFrame">
						<input type="hidden" name="boardID">
					</form>
					<form name="modifyBoardInfoFrm" method="post" action="/servlet/BoardInformationModify" target="hiddenFrame">
						<input type="hidden" name="boardID">
						<input type="hidden" name="boardName">
						<input type="hidden" name="boardReplyPolicyType">
						<input type="hidden" name="boardWritePermissionType">
