...
<script type='text/javascript'>
	function init() {		
		if (parent != null && parent.callBackForBoadInfoAddition != null) {
			parent.callBackForBoadInfoAddition("<%= boardID %>");
		} else {
			alert("parent.callBackForBoadInfoAddition 이 존재하지 않습니다");
		}
	}
	window.onload = init;
</script>
