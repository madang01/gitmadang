...
<script type='text/javascript'>
	function init() {		
		if (parent != null && parent.callBackForBoadInfoDeletion != null) {
			parent.callBackForBoadInfoDeletion("<%= boardID %>");
		} else {
			alert("parent.callBackForBoadInfoDeletion 이 존재하지 않습니다");
		}
	}
	window.onload = init;
</script>
