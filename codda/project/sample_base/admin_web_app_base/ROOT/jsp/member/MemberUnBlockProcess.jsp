...
<script type='text/javascript'>
	function init() {
		if (parent != null && parent.callBackForMemberUnBlockProcess != null) {
			parent.callBackForMemberUnBlockProcess();
		} else {
			alert("parent.callBackForMemberUnBlockProcess 이 존재하지 않습니다");
		}
	}
