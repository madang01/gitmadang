...
public class SbMemberTbRecord extends UpdatableRecordImpl<SbMemberTbRecord> implements Record13<String, String, String, String, String, Byte, Byte, UByte, Timestamp, Timestamp, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1380750165;
     ...
     */
    @Override
    public Row13<String, String, String, String, String, Byte, Byte, UByte, Timestamp, Timestamp, Timestamp, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row13<String, String, String, String, String, Byte, Byte, UByte, Timestamp, Timestamp, Timestamp, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public SbMemberTbRecord values(String value1, String value2, String value3, String value4, String value5, Byte value6, Byte value7, UByte value8, Timestamp value9, Timestamp value10, Timestamp value11, Timestamp value12, Timestamp value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SbMemberTbRecord(String userId, String nickname, String email, String pwdBase64, String pwdSaltBase64, Byte role, Byte state, UByte pwdFailCnt, Timestamp regDt, Timestamp lastNicknameModDt, Timestamp lastEmailModDt, Timestamp lastPwdModDt, Timestamp lastStateModDt) {
        super(SbMemberTb.SB_MEMBER_TB);
