...
/**
 * RootMenuAddRes server codec
 * @author Won Jonghoon
 *
 */
public final class RootMenuAddResServerCodec implements MessageCodecIF {

	private AbstractMessageEncoder messageEncoder = new RootMenuAddResEncoder();
