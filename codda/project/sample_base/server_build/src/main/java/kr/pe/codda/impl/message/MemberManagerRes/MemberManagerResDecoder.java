...
/**
 * MemberManagerRes message decoder
 * @author Won Jonghoon
 *
 */
public final class MemberManagerResDecoder extends AbstractMessageDecoder {
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Object  middleReadableObject) throws BodyFormatException {
		...
		memberManagerRes.setMemberState((Byte)
		...
		memberManagerRes.setSearchID((String)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
			, "searchID" // itemName
		...
		memberManagerRes.setFromDateString((String)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
		...
		memberManagerRes.setToDateString((String)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
		...
		memberManagerRes.setPageNo((Integer)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
			, "pageNo" // itemName
		...
		memberManagerRes.setPageSize((Integer)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
			, "pageSize" // itemName
		...
		memberManagerRes.setIsNextPage((java.lang.Boolean)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
			, "isNextPage" // itemName
		...
		memberManagerRes.setCnt((Integer)
		singleItemDecoder.getValueFromReadableMiddleObject(pathStack.peek()
			, "cnt" // itemName
			, kr.pe.codda.common.type.SingleItemType.INTEGER // itemType
			, -1 // itemSize
		...
		int member$2ListSize = memberManagerRes.getCnt();
		...
		java.util.List<MemberManagerRes.Member> member$2List = new java.util.ArrayList<MemberManagerRes.Member>();
		for (int i2=0; i2 < member$2ListSize; i2++) {
			...
			MemberManagerRes.Member member$2 = new MemberManagerRes.Member();
		...
		memberManagerRes.setMemberList(member$2List);
