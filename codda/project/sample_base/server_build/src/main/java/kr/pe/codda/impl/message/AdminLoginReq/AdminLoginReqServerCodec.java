...
public final class AdminLoginReqServerCodec implements MessageCodecIF {
	...
	public AbstractMessageEncoder getMessageEncoder() throws DynamicClassCallException {
		throw new DynamicClassCallException("the server don't need a message encoder because it is a message[AdminLoginReq] that is not sent from server to client");
	}
}