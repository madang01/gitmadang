...
/**
 * MemberSearchRes message
 * @author Won Jonghoon
 *
 */
public class MemberSearchRes extends AbstractMessage {
	...
	public static class Member {
		...
		public short getPasswordFailCount() {
			return passwordFailCount;
		}

		public void setPasswordFailCount(short passwordFailCount) {
		...
		public String toString() {
			...
			builder.append(nickname);
			builder.append(", passwordFailCount=");
			builder.append(passwordFailCount);
	...
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("memberSearchRes[");
