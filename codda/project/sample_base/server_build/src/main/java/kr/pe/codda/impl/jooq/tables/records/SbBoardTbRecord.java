...
public class SbBoardTbRecord extends UpdatableRecordImpl<SbBoardTbRecord> implements Record15<UByte, UInteger, UInteger, UShort, UInteger, UByte, String, String, String, Integer, String, UInteger, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = -950296504;
    ...
    /**
     * Setter for <code>sb_db.sb_board_tb.next_attach_sq</code>. 다음 첨부 파일 시퀀스 번호, 0부터 시작
     */
    public void setNextAttachSq(UInteger value) {
        set(11, value);
    }

    /**
     * Getter for <code>sb_db.sb_board_tb.next_attach_sq</code>. 다음 첨부 파일 시퀀스 번호, 0부터 시작
     */
    public UInteger getNextAttachSq() {
     ...
     */
    @Override
    public Row15<UByte, UInteger, UInteger, UShort, UInteger, UByte, String, String, String, Integer, String, UInteger, String, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row15<UByte, UInteger, UInteger, UShort, UInteger, UByte, String, String, String, Integer, String, UInteger, String, Timestamp, Timestamp> valuesRow() {
    ...
    public Field<UInteger> field12() {
        return SbBoardTb.SB_BOARD_TB.NEXT_ATTACH_SQ;
    }
     ...
     */
    @Override
    public SbBoardTbRecord value10(Integer value) {
        setViewCnt(value);
        return this;
    }
     ...
     */
    @Override
    public SbBoardTbRecord value11(String value) {
        setBoardSt(value);
        return this;
    }
     ...
     */
    @Override
    public SbBoardTbRecord value12(UInteger value) {
        setNextAttachSq(value);
        return this;
    }
     ...
     */
    @Override
    public SbBoardTbRecord values(UByte value1, UInteger value2, UInteger value3, UShort value4, UInteger value5, UByte value6, String value7, String value8, String value9, Integer value10, String value11, UInteger value12, String value13, Timestamp value14, Timestamp value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SbBoardTbRecord(UByte boardId, UInteger boardNo, UInteger groupNo, UShort groupSq, UInteger parentNo, UByte depth, String writerId, String subject, String content, Integer viewCnt, String boardSt, UInteger nextAttachSq, String ip, Timestamp regDt, Timestamp modDt) {
        super(SbBoardTb.SB_BOARD_TB);
