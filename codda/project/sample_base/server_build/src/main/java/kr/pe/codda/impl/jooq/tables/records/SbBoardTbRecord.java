...
public class SbBoardTbRecord extends UpdatableRecordImpl<SbBoardTbRecord> implements Record10<UByte, UInteger, UInteger, UShort, UInteger, UByte, Integer, String, UByte, String> {

    private static final long serialVersionUID = 1620010883;
    ...
    /**
     * Setter for <code>sb_db.sb_board_tb.board_st</code>. 게시글 상태, B : 블락, D : 삭제된 게시글, Y : 정상 게시글
     */
    ...
    /**
     * Getter for <code>sb_db.sb_board_tb.board_st</code>. 게시글 상태, B : 블락, D : 삭제된 게시글, Y : 정상 게시글
     */
     ...
     */
    @Override
    public Row10<UByte, UInteger, UInteger, UShort, UInteger, UByte, Integer, String, UByte, String> fieldsRow() {
     ...
     */
    @Override
    public Row10<UByte, UInteger, UInteger, UShort, UInteger, UByte, Integer, String, UByte, String> valuesRow() {
     ...
     */
    @Override
    public SbBoardTbRecord values(UByte value1, UInteger value2, UInteger value3, UShort value4, UInteger value5, UByte value6, Integer value7, String value8, UByte value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SbBoardTbRecord(UByte boardId, UInteger boardNo, UInteger groupNo, UShort groupSq, UInteger parentNo, UByte depth, Integer viewCnt, String boardSt, UByte nextAttachedFileSq, String pwdBase64) {
        super(SbBoardTb.SB_BOARD_TB);
