...
public class SbBoardTbRecord extends UpdatableRecordImpl<SbBoardTbRecord> implements Record9<UByte, UInteger, UInteger, UShort, UInteger, UByte, Integer, String, UByte> {

    private static final long serialVersionUID = -199503441;
     ...
     */
    @Override
    public Row9<UByte, UInteger, UInteger, UShort, UInteger, UByte, Integer, String, UByte> fieldsRow() {
     ...
     */
    @Override
    public Row9<UByte, UInteger, UInteger, UShort, UInteger, UByte, Integer, String, UByte> valuesRow() {
     ...
     */
    @Override
    public SbBoardTbRecord values(UByte value1, UInteger value2, UInteger value3, UShort value4, UInteger value5, UByte value6, Integer value7, String value8, UByte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SbBoardTbRecord(UByte boardId, UInteger boardNo, UInteger groupNo, UShort groupSq, UInteger parentNo, UByte depth, Integer viewCnt, String boardSt, UByte nextAttachedFileSq) {
        super(SbBoardTb.SB_BOARD_TB);
