...
public class SbBoardTbRecord extends UpdatableRecordImpl<SbBoardTbRecord> implements Record15<UByte, UInteger, UInteger, UShort, UInteger, UByte, String, String, String, UInteger, Integer, String, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = 26935797;
     ...
     */
    @Override
    public Row15<UByte, UInteger, UInteger, UShort, UInteger, UByte, String, String, String, UInteger, Integer, String, String, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row15<UByte, UInteger, UInteger, UShort, UInteger, UByte, String, String, String, UInteger, Integer, String, String, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public SbBoardTbRecord values(UByte value1, UInteger value2, UInteger value3, UShort value4, UInteger value5, UByte value6, String value7, String value8, String value9, UInteger value10, Integer value11, String value12, String value13, Timestamp value14, Timestamp value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SbBoardTbRecord(UByte boardId, UInteger boardNo, UInteger groupNo, UShort groupSq, UInteger parentNo, UByte depth, String writerId, String subject, String content, UInteger attachId, Integer viewCnt, String boardSt, String ip, Timestamp regDt, Timestamp modDt) {
        super(SbBoardTb.SB_BOARD_TB);
