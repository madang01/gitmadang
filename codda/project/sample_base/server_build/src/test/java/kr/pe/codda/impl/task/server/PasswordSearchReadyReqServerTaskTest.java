...
public class PasswordSearchReadyReqServerTaskTest extends AbstractJunitTest {
	...
	public void 비밀번호찾기준비_비밀번호최대횟수초과() {
		...
		try {
			...
			String errorMessage = e.getMessage();
			String expectedErrorMessage = new StringBuilder().append("아이디 혹은 비밀번호 찾기로 비밀번호 틀린 횟수가  최대 횟수 ")
	...
	public void 비밀번호찾기준비_최대요청초과() {
		...
		try {
			...
			String errorMessage = e.getMessage();
			String expectedErrorMessage = new StringBuilder().append("아이디 혹은 비밀번호 찾기 재시도 횟수가 최대 횟수 ")
	...
	@Test
	public void test() {
		String recipient = "k9200544@hanmail.net";
